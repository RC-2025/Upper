...
static const _Sbus_type_support_symbol_names_t _Sbus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rc_interaction, msg, Sbus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rc_interaction, msg, Sbus)),
  }
};
...
{
  return &::rc_interaction::msg::rosidl_typesupport_cpp::Sbus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rc_interaction, msg, Sbus)() {
  return get_message_type_support_handle<rc_interaction::msg::Sbus>();
}
